-- ========================================================================
-- GMA DYNAMICS: SCHEMA MAESTRO DE SEGURIDAD (VERSIÓN FINAL CON CONTROL DE FECHAS)
-- ========================================================================
...
CREATE TABLE IF NOT EXISTS public.profiles (
  ...
  plan_start_date TIMESTAMP WITH TIME ZONE DEFAULT timezone('utc'::text, now())
);
...
-- 7. FUNCIÓN RPC: EDICIÓN DE PLAN (Desde Admin)
...
GRANT EXECUTE ON FUNCTION public.get_all_users_admin() TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.admin_update_user_plan(uuid, text, integer, text, timestamptz) TO anon, authenticated, service_role;
